<template>
    <div id="component" class="Amaterasu">
        ...
        <link href="assets/album.css" rel="stylesheet">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8 col-md-7 py-4">
                                ...
                                <p class="text-muted">Add some information about the album below, the author, or any
            ...
            <footer className="text-muted">
                <div className="container">
                    ...
                    <p>New to Bootstrap? <a href="https://getbootstrap.com/">Visit the homepage.</a></p>
                </div>
            </footer>
    </div>
</template>
